...
def test_leverage_score_sampling():
    ...
    # Plotting
    us.plot_num_points_vs_accuracy_and_P_rule(num_points_list, accuracy_list, p_rule_list, "Fairness","levarage_score sampling")
    us.plot_num_points_vs_accuracy_and_P_rule(num_points_list, accuracy_list2, p_rule_list2, "Accuracy","levarage_score sampling")
